import { Center, FlatList, Flex, HStack, Icon, Spinner, Text, VStack } from 'native-base';
...
const GroupCard = ({ data, user, navigation, paginateFunction, currentPage, totalPages, totalCount, currentCount, hasNextPage, hasPrevPage, fetchAgain, setFetchAgain, loading }) => {
