    ...
    <>
        ...
        >
            <GridItem colSpan={4}>
                <Box>
                    <VideoPlayer />
                    <Heading pt='20px' pb='35px' as='h1' size='lg' fontWeight='500'>Love A Fair With Darshan Raval</Heading>
                    ...
                    <NavLink style={{"margin": "0 20px"}} className='btn btn-primary' to="./create">
                        <Flex alignItems='center'>
                    ...
                    <Box>
                        ...
                        <Text pt='20px'>
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nihil dolore facere quaerat praesentium adipisci ex doloribus tenetur ab optio doloremque temporibus aliquam aliquid alias, animi excepturi! Nobis eos eaque maiores perspiciatis quidem necessitatibus nostrum consequatur fugiat voluptatibus? Perferendis provident fugiat quibusdam saepe atque earum labore, fugit quam quos cum culpa iste deserunt sint. Magni inventore, voluptas reiciendis, ea, minima vitae quod possimus totam consequatur vel facere! Sunt exercitationem eveniet harum. Tenetur voluptatem commodi officiis recusandae fugiat quisquam sunt dolorem? Cumque, assumenda aliquam! Officia provident ullam explicabo consectetur. Rerum consequatur inventore facilis accusantium optio perspiciatis obcaecati! Eius deleniti optio vitae possimus.
                        </Text>
                    </Box>
                    <Box py='40px'><hr /></Box>
                        <Flex alignItems='center'>
                            <Image h='18px' pe='10px' src={CDN_IMAGES+"/comment.png"} /> 
                            <Text fontWeight='bold'>Comments</Text>
                        </Flex>
                </Box>
            </GridItem>
            <GridItem colSpan={2}>
                <Heading as='h2' pb='20px' size='md' fontWeight='500'>Related Events</Heading>
