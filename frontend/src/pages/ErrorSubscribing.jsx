    ...
    return (
        <Static>
            ...
            >
                ...
                />
                <Heading py='20px' as='h1' size='lg' fontWeight='500'>
                    Error Subscribing
                </Heading>
                <Text maxW='450px' textAlign='center'>
                    There was error while subscribing to the membership. You can
                    retry subscribing from the plans page present in settings.
                </Text>
            </Box>
        </Static>
    );
