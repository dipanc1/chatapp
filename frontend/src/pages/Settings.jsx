            ...
            <div className="tab-content">
                <div className={"tab-content-item "+(activeTab===1 ? "current" : "")}>
                    <Grid mt='70px' templateColumns='repeat(2, 1fr)' gap='5rem' rowGap='3rem' className='form-wrapper form-details'>
                        <GridItem w='100%'>
                            <FormControl className="filled">
                                <Input pt='25px' pb='20px' type='text' value="John Doe" />
                                <FormLabel>FULL NAME</FormLabel>
                            </FormControl>
                        </GridItem>
                        <GridItem w='100%'>
                            <FormControl className="filled">
                                <Input pt='25px' pb='20px' type='text' value="johndoe@hotmail.com" />
                    ...
                    <Grid mt='30px' templateColumns='repeat(2, 1fr)' gap='5rem' rowGap='3rem' className='form-wrapper form-details'>
                        <GridItem w='100%'>
                            <FormControl className="filled">
                                <Input pt='25px' pb='20px' type='text' value="+1 365 792 0132" />
                                <FormLabel>MOBILE</FormLabel>
                            </FormControl>
                        </GridItem>
                        <GridItem w='100%'>
                            <FormControl className="filled">
                                <Input pt='25px' pb='20px' type='text' value="www.chatapp.com/johndoe" />
                ...
                <div className={"tab-content-item "+(activeTab===3 ? "current" : "")}>
                    ...
                    <Grid mt='20px' templateColumns='repeat(2, 1fr)' gap='5rem' rowGap='3rem' className='form-wrapper'>
                        <GridItem w='100%'>
                            <FormControl className={!currentPassword == "" ? "filled" : ""}>
                    ...
                    <Grid mt='30px' templateColumns='repeat(2, 1fr)' gap='4.5rem' rowGap='3rem' className='form-wrapper'>
                        <GridItem w='100%'>
                            <FormControl className={!newPassword == "" ? "filled" : ""}>
                                <Input type='text' value={newPassword} onChange={(e) => setNewPassword(e.target.value)} />
                                <FormLabel>New Password</FormLabel>
                            </FormControl>
                        </GridItem>
                        <GridItem w='100%'>
                            <FormControl className={!confirmPassword == "" ? "filled" : ""}>
