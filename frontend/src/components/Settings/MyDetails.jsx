import { Avatar, Button, Flex, FormControl, FormLabel, Grid, GridItem, IconButton, Image, Input, Text, useColorMode, useToast } from '@chakra-ui/react'
...
const MyDetails = ({ username, setUsername, pic, setPic, number, setLoading }) => {
    ...
    const { dispatch, userInfo, getCloudinarySignature, timestamp, signature } = useContext(AppContext);
