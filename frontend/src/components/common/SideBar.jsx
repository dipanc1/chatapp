    ...
    return (
        <>
            <Box
                ...
                position='fixed'
                transform={[
                    toggleSidebar ? 'unset' : 'translateX(-100%)',
                    toggleSidebar ? 'unset' : 'translateX(-100%)',
                    'unset',
                ]}
                boxShadow={[
                    toggleSidebar ? '-50px 0 250px rgba(0,0,0,0.5)' : 'unset',
                    toggleSidebar ? '100px 0 250px rgba(0,0,0,0.5)' : 'unset',
                    'Base',
                ]}
