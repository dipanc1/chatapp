...
const Message = ({ messages, own, sameSender, sameTime }) => {
    ...
    return selectedChat?._id === messages?.chat._id ? (
        <Box
            display={'flex'}
            ...
            <Box display={'flex'}>
                {sameSender ? (
                    <Avatar
                        size='sm'
                        mr={'1.5'}
                        name={messages.sender.username}
                        src={messages.sender.pic}
                    />
                ) : (
                        ...
                        >
                            ...
                            <Text
                                color={
                                    own
                                        ? 'white'
                                        : `${colorMode === 'light' ? '' : '#2b2929'}`
                                }
                            >
                                {
                                    messages.content.split('/')[
                                        messages.content.split('/').length - 1
                                    ]
                                }
                            </Text>
                        </Box>
