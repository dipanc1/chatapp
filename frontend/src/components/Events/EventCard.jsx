...
const EventCard = ({
    ...
    const deleteEvent = async (id) => {
        ...
        try {
            await eventsApi
                .deleteEvent(id, selectedChat._id, config)
                .then((res) => {
                    toast({
                        title: 'Event Deleted!',
            ...
            await eventsApi
                .getEvents(selectedChat._id, config)
                .then((res) => {
    ...
    return (
        <>
                    ...
                    <Box position='absolute' right='0' top='0' zIndex='1'>
                        {!eventsPage && admin && (
                            ...
                            >
                                <Image
                                    height='22px'
                                    src='https://ik.imagekit.io/sahildhingra/3dot-menu.png'
                                />
                            </Button>
                        )}
                        {toggleEventMenu && (
                                ...
                                <UnorderedList listStyleType='none' ms='0'>
                                    ...
                                    >
                                        <Image
                                            h='22px'
                                            me='15px'
                                            src='https://ik.imagekit.io/sahildhingra/draw.png'
                                        />
                                        <Text>Edit</Text>
                                    </ListItem>
                                    <ListItem
                                    ...
                                    >
                                        <Image
                                            h='22px'
                                            me='15px'
                                            src='https://ik.imagekit.io/sahildhingra/trash.png'
                                        />
            ...
            <EventModal
                type={'Update'}
                createEventLoading={editEventLoading}
                isOpenCreateEvent={isOpenEditEvent}
                onCloseCreateEvent={onCloseEditEvent}
                name={name}
                setEventName={setEventName}
                description={descriptiond}
                setDescription={setDescriptiond}
                date={dated}
                setDate={setDated}
                time={timed}
                setTime={setTimed}
