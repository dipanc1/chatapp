...
const GroupCard = ({
    ...
    const openMembersModal = async () => {
        try {
            ...
            const { data } = await conversationApi.getEncryptedChatUrl(
                chatId,
                config,
            );
            onAddOpen();
    ...
    return (
        <Box p='18px 29px' borderRadius='10px' border='0'>
                ...
                <Flex>
                    ...
                    {isAdmin && (
                        <Image
                            ml='17px'
                            h='32px'
                            src='https://ik.imagekit.io/sahildhingra/crown-icon.png'
                        />
                    )}
                </Flex>
                {isAdmin && (
                    <Box position='relative'>
                        <Image
                            onClick={() => setToggleGroupMenu(!toggleGroupMenu)}
                            px='10px'
                            cursor='pointer'
                            h='32px'
                                ...
                                <UnorderedList listStyleType='none' ms='0'>
                                    ...
                                    >
                                        <Image
                                            h='22px'
                                            me='15px'
                                            src='https://ik.imagekit.io/sahildhingra/user.png'
                                        />
                                        <Text
                                            color={
                                                colorMode === 'light'
                                    ...
                                    >
                                        <Image
                                            h='22px'
                                            me='15px'
                                            src='https://ik.imagekit.io/sahildhingra/events.png'
                                        />
                                        <Text
                                            color={
                                                colorMode === 'light'
            ...
            <Flex pt='60px' justifyContent='space-between'>
                <Box>
                    <Text
                        color={colorMode === 'dark' ? '#805AD5' : '#032E2B'}
                        fontWeight='600'
                        as='h3'
                    >
                        Members
                ...
                <Box textAlign='right'>
                    ...
                    <Text color='#737373'>
                        {upcomingEvents.find((event) => event.chatId === chatId)
                            ? upcomingEvents.find(
