...
function App() {
    let isChrome = navigator.userAgentData?.brands?.some(
            ...
            {!isChrome ? (
                ...
                >
                    <Text fontSize={'2xl'} color={'white'}>
                        This website is only supported on Google Chrome
                    </Text>
                </Box>
            ) : !cameraPermission ? (
                <Box
                ...
                >
                    <Box w='100%' textAlign='center'>
                        ...
                        <Box fontSize='lg' mb='2'>
                            If you have already allowed camera permission,
                ...
                <AnimatePresence exitBeforeEnter initial={false}>
                    <Routes>
                        ...
                        <Route
                            ...
                            element={<SubscribedSuccessfully />}
                        />
                        <Route
                            path='error-subscribing'
                            element={<ErrorSubscribing />}
                        />
