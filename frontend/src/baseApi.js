...
const videoUpload = `https://api.cloudinary.com/v1_1/${cloudName}/video/upload`;
...
export { backend_url, pictureUpload, stripePublicKey, stripePublicKeyLive, videoUpload };