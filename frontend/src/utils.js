...
const stripePublicKey =
    'pk_live_51N136dLHtaKT8adLWUXk47jhkVHamgXVLXBS5vFbdIwQG01AsuW1F6WklizqXGnX0i9vs4JljRnmW3c8sGxZXVd400btdszLTs';
...
const checkFileExtension = (url) => {
    ...
    if (
        ...
        url.includes('.gz') ||
        url.includes('.ini') ||
        (url.split('.').slice(-3)[2] !== undefined && url.startsWith('http'))
    ) {
        return FILE;
    }
};
